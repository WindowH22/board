...
class ArticleControllerTest {
    ...
    @WithMockUser // user정보를 mocking해서 준다. 인증되었다라는 시그널을 보내주는거다.
    @DisplayName("[view][GET] 게시글  (단일) 페이지 - 정상 호출, 인증된 사용자")
    @Test
    ...
    @DisplayName("[view][GET] 게시글  (단일) 페이지 - 인증 없을 떈 로그인 페이지로 이동")
    @Test
    void givenNothing_whenRequestingArticleView_thenRedirectsToLoginPages() throws Exception {
        // Given
        Long articleId = 1L;
    ...
    @Test
    void givenNothing_whenRequestingArticlesSearchHashtagView_thenReturnsArticlesSearchHashtagView() throws Exception {
        // Given
    ...
    @Test
    void givenHashtag_whenRequestingArticlesSearchHashtagView_thenReturnsArticlesSearchHashtagView() throws Exception {
        // Given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java","#spring","#boot");
    ...
    @WithUserDetails(value = "changTest", setupBefore = TestExecutionEvent.TEST_EXECUTION) // 실제 user데이터를 사용할수 있다.
    ...
    @WithUserDetails(value = "changTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
